...
I'm going to perform Data Cleaning & Exploratory Data Analysis, assess the missingness an dependencies of specific groups within data, perform hypothesis test to analyze whether causes of power outages are dependent on seasons of year ( Summer, Winter, etc.).
